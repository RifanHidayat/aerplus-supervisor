...
class EditLeaveSubmissionPage extends StatefulWidget {
  String? remainingLeave;
  var date, leaveDates, attachment, note, id;

  EditLeaveSubmissionPage(
      {this.remainingLeave,
      this.note,
      this.date,
      this.attachment,
  ...
  @override
  _EditLeaveSubmissionPageState createState() =>
      _EditLeaveSubmissionPageState();
}

class _EditLeaveSubmissionPageState extends State<EditLeaveSubmissionPage> {
  ...
  void initState() {
    ...
    var dates = widget.leaveDates.split(',');
          ...
          : Container(
              ...
              child: ElevatedButton(
                  onPressed: () async {
                    ...
                    context.read<LeaveBloc>().add(EditLeaveSubmission(
                        id: widget.id,
