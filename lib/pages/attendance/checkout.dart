...
// wrapper around the location API
  ...
  void chooseImageLongShift() async {
    var checkinImage =
        await ImagePicker().pickImage(source: ImageSource.camera);
    if (checkinImage != null) {
      setState(() {
